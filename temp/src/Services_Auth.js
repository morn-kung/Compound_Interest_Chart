...
/**
 * Login function - ตรวจสอบ username/password และสร้าง token
...
/**
 * สร้าง token สำหรับ user หลัง login สำเร็จ
 * (ตัวอย่างนี้ใช้ random string, ถ้าต้องการ JWT ต้องใช้ library เพิ่มเติม)
 */
