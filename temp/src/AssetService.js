 ...
 * Provides functions for asset retrieval, validation, and statistics
 */

/**
 * Get all assets from the Assets sheet
 * @returns {Object} Response with assets data
 */
function getAssets() {
  try {
 ...
 * @returns {Object} Response with asset data
 */
...
/**
 * Get assets by type (Crypto, Forex, etc.)
 * @param {string} assetType - Type of asset to filter
